...
export default function EditEventForm({ initial }: { initial: Event }) {
  ...
  const [form, setForm] = useState({
    ...
    periodStart: initial.periodStart ? initial.periodStart.slice(0, 16) : "",
    periodEnd: initial.periodEnd ? initial.periodEnd.slice(0, 16) : "",
  ...
  useEffect(() => {
    fetch("/api/exchanges").then((r) => r.json()).then(setExchanges);
  }, []);
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold">이벤트 수정</h2>
